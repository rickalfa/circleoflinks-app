<section id="api-features" class="container" style="margin-top: 160px;">

  <div class="card"> 
  <h2 class="text-center mb-4" style="margin-top: 160px;">Características principales de la API Circle of Links</h2>
  ...
  <div class="m-2 p-1 " style="border-block-start-style: solid; border-color:aqua;
   height: 19rem"> 
